...
//    @JoinColumns({
//        @JoinColumn(name = "id_intermediario", referencedColumnName = "id_intermediario", insertable = false, updatable = false),
//        @JoinColumn(name = "chiave_banca", referencedColumnName = "chiave_banca", insertable = false, updatable = false)
//    })
//    private MerchantAccount merchantAccount;

    public Transaction(Long id, Ingestion ingestion, String tpRec, String idIntermediario, String idEsercente, String chiaveBanca,
